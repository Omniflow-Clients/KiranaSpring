	...
	return (
		<SiteShell>
			<section className="mx-auto max-w-3xl px-6 py-20 text-center">
				<Badge
					variant="outline"
					className="mb-4 rounded-full px-4 py-1 text-primary"
				>
				...
				<p className="mx-auto mb-8 max-w-xl text-base leading-8 text-muted-foreground">
					Cek kembali slug artikel atau kembali ke daftar blog untuk melihat
					semua tulisan yang sudah dipublikasikan.
				</p>
